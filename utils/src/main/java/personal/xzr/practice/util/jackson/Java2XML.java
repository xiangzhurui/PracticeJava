package personal.xzr.practice.util.jackson;
...
import personal.xzr.practice.util.jackson.bean.Address;
import personal.xzr.practice.util.jackson.bean.Customer;
