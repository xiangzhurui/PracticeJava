...
package com.xiangzhurui.sample.ftp;
 ...
 * same as the host you run it on (for security reasons, some com.xzr.practice.util.ftp servers only
...
public final class ServerToServerFTP {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 8) {
            System.err.println("Usage: com.xzr.practice.util.ftp <host1> <user1> <pass1> <file1> <host2> <user2> <pass2> <file2>");
            System.exit(1);
        }
